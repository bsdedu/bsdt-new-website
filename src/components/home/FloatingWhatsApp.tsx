...
export const FloatingWhatsApp: React.FC = () => {
  ...
  const whatsappNumber = "917204006339";
  ...
  return (
    <button
      onClick={handleClick}
      className={cn(
        "fixed bottom-6 left-4 md:left-8 z-50 w-14 h-14 rounded-full bg-[#25D366] shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-xl",
