          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6 lg:gap-10 w-full md:w-auto justify-center md:justify-end overflow-x-auto no-scrollbar">
              <div className="flex flex-col items-center justify-center flex-shrink-0">
                <img alt="Bengaluru North University Logo" className="h-8 md:h-10 object-contain brightness-0 invert opacity-80" src="/lovable-uploads/ebe4320d-da29-4489-9357-5d206b258604.png" />
              </div>
              <div className="flex flex-col items-center justify-center flex-shrink-0">
