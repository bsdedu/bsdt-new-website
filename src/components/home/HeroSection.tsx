          ...
          <div className="flex justify-end">
            <div className={cn("max-w-xl bg-black/40 backdrop-blur-sm p-8 md:p-12 rounded-lg border border-white/10 transition-all duration-700", isLoaded ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10")}>
              ...
              <div className="flex flex-wrap gap-4">
                <Button size="lg" variant="outline" className="border-2 border-[#f5f5f0] bg-[#f5f5f0] text-black hover:bg-white hover:border-white transition-all duration-300 font-semibold px-8" onClick={() => window.open(currentSlide === 2 ? "https://docs.google.com/forms/d/e/1FAIpQLSfJHlSTNhMYjU9ulXi8JiPPJQW1Jw-C_JiUe7WGiIHIOpKe3Q/viewform" : "https://apply.bsd.edu.in/", "_blank", "noopener noreferrer")}>
