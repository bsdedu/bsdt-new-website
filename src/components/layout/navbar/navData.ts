    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Master Dip. Interior Design', href: '/academics/master-diploma-in-interior-design' },
          ...
          { name: 'Professional Dip. in Fashion Design', href: '/academics/professional-diploma-fashion-design' },
