        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              {['Design', 'Engineering', 'Technology', 'Fine Arts', 'Architecture'].map(program => <li key={program}>
                  <a href="#" className="text-sm text-white/80 hover:text-white transition-colors hover-lift inline-block">
                    {program}
                  </a>
                </li>)}
            </ul>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              {['Admissions', 'Scholarships', 'Student Life', 'Campus Map', 'Alumni'].map(resource => <li key={resource}>
                  <a href="#" className="text-sm text-white/80 hover:text-white transition-colors hover-lift inline-block">
                    {resource}
                  </a>
                </li>)}
