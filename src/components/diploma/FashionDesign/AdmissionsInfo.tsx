        ...
        <RevealSection>
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-display font-bold text-bsd-gray">
              Join Our Fashion Design Program
            </h2>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-foreground/70">12th Grade completion from any stream</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-bsd-gray">Creative Interest</h4>
                    <p className="text-foreground/70">Passion for fashion design and creativity</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-bsd-gray">Selection Process</h4>
                    <p className="text-foreground/70">Personal interview and aptitude assessment</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-bsd-gray">Portfolio</h4>
                    <p className="text-foreground/70">Portfolio submission for advanced applicants (optional)</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-bsd-gray">Batch Size</h4>
                    <p className="text-foreground/70">Limited to 25 students per batch</p>
                  </div>
                  <div>
