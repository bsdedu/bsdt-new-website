        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-foreground/80 max-w-xl">
              A comprehensive professional diploma program that equips students with interior design skills for residential and commercial spaces, focusing on aesthetic and functional design solutions.
            </p>
