        ...
        <RevealSection>
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-display font-bold text-bsd-gray">
              Join Our HCI for UI/UX Diploma Program
            </h2>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-bsd-gray">Technical Aptitude</h4>
                    <p className="text-foreground/70">Basic computer literacy required; design experience beneficial but not mandatory</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-foreground/70">6 Months (1 Semester)</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70">Weekday classes (Mon, Tue & Wed, 09:30 AM to 4:30 PM)</p>
                  </div>
