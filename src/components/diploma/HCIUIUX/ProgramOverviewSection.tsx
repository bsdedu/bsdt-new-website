            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-foreground/70">
                  The Professional Diploma in HCI for UI/UX is a specialized 12-month program that combines theoretical knowledge with practical skills in creating user-centered digital experiences. You'll learn how to research user needs, design intuitive interfaces, conduct usability testing, and implement effective UI/UX solutions.
                </p>
                <p className="text-foreground/70">
