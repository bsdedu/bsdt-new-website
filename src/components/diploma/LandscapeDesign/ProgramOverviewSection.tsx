        ...
        <RevealSection>
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="mt-4 text-foreground/70">
              This 12-month hybrid program blends live online classes with offline, real-world learning at our Bangalore campus or Satellite Partner Centres in Raipur, Hyderabad, Delhi & Coimbatore. Online sessions cover core areas including design fundamentals, planting design, ecological planning, site planning, material applications, and cost estimation.
            </p>
          </div>
        </RevealSection>
