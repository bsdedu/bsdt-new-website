        ...
        <RevealSection>
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="mt-4 text-foreground/70">
              Experience the dynamic learning environment where our BCA students actively engage in coding projects, UI/UX prototyping, and technology-driven problem solving.
            </p>
          </div>
        </RevealSection>
