...
import { Calendar, GraduationCap, BookOpen, BriefcaseBusiness, Award, Building2, BrainCircuit, Palette } from "lucide-react";
          ...
          <RevealSection>
            <div className="space-y-6">
              ...
              <p className="text-lg text-foreground/80">
                Transform your creative vision into a successful fashion career. Master garment construction, textile design, fashion illustration, and industry trends to become a versatile fashion professional.
              </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-16">
            ...
            <Card className="border-0 bg-white/80 backdrop-blur">
              <CardContent className="p-6 flex flex-col items-center text-center">
                ...
                <p className="text-sm text-foreground/70">Placement Assistance</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 bg-white/80 backdrop-blur">
              <CardContent className="p-6 flex flex-col items-center text-center">
                ...
                <p className="text-sm text-foreground/70">Fashion Specializations</p>
              </CardContent>
            </Card>
