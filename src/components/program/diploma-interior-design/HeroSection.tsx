        ...
        <RevealSection>
          <div className="flex flex-col md:flex-row items-center">
            <div className="w-full md:w-1/2 mb-8 md:mb-0 md:pr-8">
              <Badge variant="bsdOrange" className="mb-4">PROFESSIONAL DIPLOMA</Badge>
              ...
              <p className="text-lg md:text-xl text-foreground/70 mb-8">
                Master the art and science of interior spaces with our industry-recognized professional diploma program. Available in both online and offline modes to suit your learning preferences.
              </p>
            ...
            <div className="w-full md:w-1/2 relative">
              ...
              <div className="absolute -bottom-4 -right-4 bg-white p-4 rounded-lg shadow-lg hidden md:block">
                <p className="text-sm font-semibold text-bsd-gray">1 Year Professional Diploma</p>
                <p className="text-sm text-foreground/70">Online & Offline Options</p>
              </div>
            </div>
          </div>
        </RevealSection>
