...
export const HeroSection: React.FC = () => {
  return <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 bg-bsd-light-gray overflow-hidden">
        ...
        <RevealSection>
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-1/2 relative">
              <img src="/lovable-uploads/0d8d1a0c-c39b-4ddf-baa2-5736fc824c3d.png" alt="Interior Design Studio" className="rounded-lg shadow-lg w-full" />
              <div className="absolute -bottom-4 -right-4 bg-white p-4 rounded-lg shadow-lg hidden md:block">
                ...
                <p className="text-sm text-foreground/70">3 Years Duration</p>
              </div>
            </div>
          </div>
        </RevealSection>
