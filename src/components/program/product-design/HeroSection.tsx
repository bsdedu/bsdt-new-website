...
import { Calendar, GraduationCap, BookOpen, BriefcaseBusiness, Award, Building2, BrainCircuit, Package } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <RevealSection>
            <div className="space-y-6">
              ...
              <p className="text-lg text-foreground/80">
                Shape the future of everyday objects through innovative product design. Master the art of creating functional, aesthetic, and user-centered products that solve real-world problems.
              </p>
          ...
          <RevealSection direction="left">
            <div className="relative rounded-2xl overflow-hidden shadow-lg h-[400px]">
              <img src="https://images.unsplash.com/photo-1586717799252-bd134ad00e26?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="Product Design Studio" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent">
                <div className="absolute bottom-0 left-0 p-6">
                  <p className="text-white font-medium text-lg">Designing products that enhance human experience</p>
                </div>
              </div>
            </div>
          </RevealSection>
        ...
        <RevealSection delay={200}>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-16">
            ...
            <Card className="border-0 bg-white/80 backdrop-blur">
              <CardContent className="p-6 flex flex-col items-center text-center">
                <div className="w-12 h-12 rounded-full bg-bsd-orange/10 flex items-center justify-center mb-3">
                  <Package className="w-6 h-6 text-bsd-orange" />
                </div>
                <h3 className="text-3xl font-bold text-bsd-gray">500+</h3>
                <p className="text-sm text-foreground/70">Product Prototypes</p>
              </CardContent>
            </Card>
