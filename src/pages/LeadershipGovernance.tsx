...
const LeadershipGovernance = () => {
  ...
  const leadershipTeam = [
    ...
    },
    {
      ...
      bio: "Dipti leads academic planning and institutional growth with a strong focus on culture, history, and human-centered design. She works closely with faculty and administration to shape curriculum frameworks, strengthen academic systems, and nurture an environment where learning remains thoughtful, contextual, and deeply connected to human experience.",
      image: diptiImage
    },
    {
      name: "Sharan Desai",
  ...
  const committees = [
    ...
    },
    {
      ...
      members: ["Ar Preethi Dineshwar (Head)", "Ar Hema Wadikar (Faculty Representative)", "Aasritha Upadhyayula (Faculty Representative)", "Devanshi (BSc 2 Student Representative)", "Renuka (BSc 4 Student Representative)", "Amrita (BSc 6 Student Representative)", "Palak Kaur (BVA 2 Student Representative)", "Fiza Sultana (BVA ID 4 Student Representative)", "Charitha (BVA GD 4 Student Representative)", "Amrita (BVA ID 6 Student Representative)", "Rebecca (BDes 2 Student Representative)", "Haripriya (BCA 2 Student Representative)"]
    },
    {
      ...
      members: ["Mr Sharan Desai (Chairperson)", "Ar Preethi Dineshwar (Adviser)", "Ar Dipti Dineshwar (Member)", "Mrs Mamatha A (Member)", "Mr Vinod Kumar MJ (Squad)", "Mr Ritesh L (Squad)", "Ms Praisy Varghese (Squad)", "Mr Sandesh D (Squad)"]
    },
    {
      ...
      members: ["Ar Preethi Dineshwar (Member)", "Ar Dipti Dineshwar (Member)", "Er Ritesh L (Member)", "Ar Bhavna (Member)", "Mr Yogesh (Member)", "Ms Niharika (Member)", "Ms Fathima (Member)"]
    },
    {
      ...
      members: ["Mrs Parvathy (Member)", "Ar Arvind (Member)", "Mr Amal (Member)", "Er Ritesh L (Member)", "Ar Dipti Dineshwar (Member)", "Mr Vinod Kumar MJ (Member)", "Mrs Mamatha A (Member)", "Praisy Varghese (Member)", "Mansi Shrivastava (Member)", "Sandesh D (Member)"]
    }
  ];
