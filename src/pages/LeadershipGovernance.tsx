...
const LeadershipGovernance = () => {
  ...
  const committees = [
    ...
    },
    {
      ...
      members: ["Parvathy (Member)", "Arvind (Member)", "Amal (Member)", "Er Ritesh L (Member)", "Ar Dipti Dineshwar (Member)", "Vinod (Member)", "Mamatha (Member)", "Praisy Varghese (Member)", "Mansi Shrivastava (Member)", "Sandesh D (Member)"]
    }
  ];
