...
export function Page() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setIsLoaded(true);
    }, 100); // Delay to ensure hydration begins
  ...
  return (
    <> 
      ...
      <div data-hydrated={isLoaded} className={`min-h-screen flex flex-col transition-opacity duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`} >
        <Navbar />
...
// Optional: For SEO title rendering without Helmet fallback
export const documentProps = {
  title: 'BSDT | Premier Design & Tech Education in Bangalore',
  description: 'Empowering minds in design and technology through cutting-edge education.',
};
