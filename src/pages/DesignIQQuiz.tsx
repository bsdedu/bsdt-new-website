...
const DesignIQQuiz: React.FC = () => {
  ...
  const [sliderValue, setSliderValue] = useState(2); // default to middle
          ...
          >
            ...
            >
              ...
              <div className="p-6 md:p-10 overflow-y-auto flex-1">
                <button
                  onClick={resetQuiz}
                  className="absolute top-6 right-6 w-10 h-10 rounded-full bg-muted flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-muted/80 transition-colors z-10"
                  ...
                  {step === "quiz" && (
                    ...
                    >
                      ...
                      {currentQuestion.type === "slider" ? (
                              ...
                              {[0, 1, 2, 3, 4].map((i) => (
                                <div
                                  ...
                                  className={cn(
                                    ...
                                    i <= sliderValue ? "bg-bsd-orange/60" : "bg-muted-foreground/20"
                                  )}
                                />
                              ))}
                            </div>
                        ...
                        <div className={cn(
                          "mt-6 grid gap-3",
                          currentQuestion.options.some(o => o.image) ? "grid-cols-2" : "grid-cols-1 sm:grid-cols-2"
                        )}>
                              ...
                              >
                                ...
                                <div className={cn("flex items-center gap-3", hasImage ? "p-3" : "")}>
                                  <span className={cn(
                                    ...
                                    isSelected ? "bg-bsd-orange text-white" : "bg-muted text-muted-foreground"
                                  )}>
