          ...
          <TooltipProvider>
            ...
            <BrowserRouter>
              ...
              <Routes>
                ...
                <Route
                  path="/academics/professional-diploma-graphics-design-ui-ux"
                  element={<DiplomaProgramGraphicUIUX />}
                />
                <Route
                  path="/academics/professional-diploma-in-interior-design"
                  element={<DiplomaProgramInteriorDesign />}
                />
                ...
                <Route
                  path="/academics/post-graduate-diploma-in-landscape-design"
                  element={<DiplomaProgramLandscapeDesign />}
                />
                <Route
                  path="/academics/professional-diploma-sustainable-circular-design"
                  element={<DiplomaProgramSustainableCircularDesign />}
                />
                <Route
                  path="/academics/professional-diploma-ai-service-design"
                  element={<DiplomaProgramAIServiceDesign />}
                />
                <Route
                  path="/academics/professional-diploma-fashion-design"
                  element={<DiplomaProgramFashionDesign />}
                />
                <Route
                  path="/academics/master-diploma-in-interior-design"
                  element={<DiplomaProgramMasterInteriorDesign />}
                />
                <Route
                  path="/academics/professional-diploma-generative-ai-design-practice"
                ...
                <Route
                  path="/design-studio-2"
                  element={<Navigate to="/we-go-beyond-curriculum?from=design-studio-2" replace />}
                />{" "}
                {/* Updated route */}
                <Route
                  path="/workshops"
                  element={<Navigate to="/we-go-beyond-curriculum?from=workshops" replace />}
                />{" "}
                {/* New route */}
                <Route
                  path="/guest-lectures"
                  element={<Navigate to="/we-go-beyond-curriculum?from=guest-lectures" replace />}
                />{" "}
                {/* New route */}
                <Route
                  path="/off-campus-learning"
                  element={<Navigate to="/we-go-beyond-curriculum?from=off-campus-learning" replace />}
                />{" "}
                {/* New route */}
                <Route
                  path="/site-visits"
                  element={<Navigate to="/we-go-beyond-curriculum?from=site-visits" replace />}
                />{" "}
                {/* New route */}
                {/* Campus Life Routes */}
                ...
                <Route
                  path="/courses/generative-ai-creative-prototyping"
                  element={<GenerativeAICreativePrototyping />}
                />
